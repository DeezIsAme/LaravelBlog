<x-layout>
                ...
                <div class="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
                    <div class="relative w-full">
                        <label for="search"
                            class="hidden mb-2 text-sm font-medium text-gray-900
                             dark:text-gray-300">Search</label>
                        <div
                            class="flex absolute inset-y-0 left-0 
                    ...
                    <div>
                        <button type="submit"
                            ...
                            text-white rounded-lg border cursor-pointer bg-primary-700 
    ...
    <div class="my-4 py-4 px-4 mx-auto max-w-screen-xl lg:py-8 lg:px-0">
        <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                ...
                <article
                    ...
                    <div class="flex justify-between items-center mb-5 text-gray-500">
                        <a href="/posts?category={{ $post->category->slug }}">
                            <span
                                class="bg-{{ $post->category->color }}-100 text-primary-800 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded dark:bg-{{ $post->category->color }}-100 dark:text-primary-800">
                                {{ $post->category->name }}
                            </span>
                        </a>
            ...
            @empty
                <div>
                    <p class="font-semibold text-xl my-4 flex justify-center items-center w-screen">Article not
                        found!
                    </p>
